# This Makefile is for the HTML::TreeBuilderX::ASP_NET extension to perl.
#
...
#     ABSTRACT => q[Scrape ASP.NET/VB.NET sites which utilize Javascript POST-backs.]
#     AUTHOR => q[Evan Carroll <me@evancarroll.com>]
#     DIR => []
#     DISTNAME => q[HTML-TreeBuilderX-ASP_NET]
#     NAME => q[HTML::TreeBuilderX::ASP_NET]
#     NO_META => q[1]
#     PL_FILES => {  }
...
MAKE = make
FULLEXT = HTML/TreeBuilderX/ASP_NET
BASEEXT = ASP_NET
PARENT_NAME = HTML::TreeBuilderX
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/HTML/TreeBuilderX/ASP_NET.pm \
...
INST_LIBDIR      = $(INST_LIB)/HTML/TreeBuilderX
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/HTML/TreeBuilderX
...
TO_INST_PM = lib/HTML/TreeBuilderX/ASP_NET.pm \
	lib/HTML/TreeBuilderX/ASP_NET/Roles/htmlElement.pm

PM_TO_BLIB = lib/HTML/TreeBuilderX/ASP_NET.pm \
	blib/lib/HTML/TreeBuilderX/ASP_NET.pm \
	lib/HTML/TreeBuilderX/ASP_NET/Roles/htmlElement.pm \
	blib/lib/HTML/TreeBuilderX/ASP_NET/Roles/htmlElement.pm
...
DISTVNAME = HTML-TreeBuilderX-ASP_NET-0.04
...
manifypods : pure_all  \
	lib/HTML/TreeBuilderX/ASP_NET.pm \
	lib/HTML/TreeBuilderX/ASP_NET/Roles/htmlElement.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/HTML/TreeBuilderX/ASP_NET.pm $(INST_MAN3DIR)/HTML::TreeBuilderX::ASP_NET.$(MAN3EXT) \
	  lib/HTML/TreeBuilderX/ASP_NET/Roles/htmlElement.pm $(INST_MAN3DIR)/HTML::TreeBuilderX::ASP_NET::Roles::htmlElement.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/01-bad_const.t t/02-good_const.t t/03-helperFunc.t t/10-traits.t t/boilerplate.t t/pod.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-MOP" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="HTTP-Request-Form" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Moose" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="MooseX-Traits" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/HTML/TreeBuilderX/ASP_NET.pm blib/lib/HTML/TreeBuilderX/ASP_NET.pm \
	  lib/HTML/TreeBuilderX/ASP_NET/Roles/htmlElement.pm blib/lib/HTML/TreeBuilderX/ASP_NET/Roles/htmlElement.pm 
